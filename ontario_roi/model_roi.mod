...
param PV_max;           # maximum allowed PV capacity
param z{y in 1..Y};     # grid price multiplier
param B;                # battery size
param PV;               # PV capacity (KW)
param PNS;              # payments with no system
...
## OBJECTIVE ##
# objective is provided in a separate file
...
subject to PV_size_lim: PV <= PV_max;
